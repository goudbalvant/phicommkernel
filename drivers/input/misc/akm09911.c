...
#ifdef CONFIG_DEVICE_VERSION
        confirm_fdv(DEV_GEOMAGNETIC,MANUF_AKM,MANUF_AKM_ID|0x0c);
#endif
	return 0;
...
#ifdef CONFIG_DEVICE_VERSION
        register_fdv_with_desc(DEV_GEOMAGNETIC,MANUF_AKM,MANUF_AKM_ID|0x0c,AKM_INPUT_DEVICE_NAME);
#endif
